...
function display(){
    ...
    for (var i=0;i<library.length;i++)
    {
        ...
        <td><button class="btne visit mx-auto"> <a href='${library[i].url}' target='_blank'><i class="fa-solid fa-eye pe-2"></i> Visit</a></button></td>
        <td><button  onclick='delet_details(${i})' class="btne delete mx-auto "><i class="fa-solid fa-trash-can"></i> Delete</button></td>
      </tr>`
    }
